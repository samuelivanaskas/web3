...
import { addCampaign, getCampaign, donate } from "@/services/Web3Service";
...
export default function Donate() {
    ...
    return (
                ...
                <>
                    ...
                    <div className="row flex-lg-row-reverse align-itens-center g-5">
                        ...
                        <div className="col-5 mb-5" style={{height: 480, scrollbars: true}}>
                            ...
                            {
                                campaign.videoUrl
                                ? <p>Assista ao vídeo ao lado para entender sobre nossa campanha.</p>
                                : <></>
                            }
                            <p className="mb-3 fst-italic mt-5">E aí, o que achou do projeto? Já foi arrecadado {campaign.balance / 10 ** 18} BNB nesta campanha. Quanto você quer doar em (BNB)?</p>
                            <div className="mb-3">
        ...
        {
            message
            ? <div className="alert alert-sucess p-3 col-6" role="alert">{message}</div>
            : <></>
        }
        <Footer/>
        </div>
